...
class Blog extends CI_Controller{
    ...
    public function __construct(){
        ...
        if($this->session->userdata('username')){
            ...
            $this->session->set_flashdata('error', 'Anda Tidak Memiliki Access');
    ...
    public function index(){
       ...
       $config['prev_tag_close'] = '</li>';
        ...
        $config['cur_tag_open'] = '<li class="page-item active" aria-current="page"><a class="page-link" href="#cari">';
